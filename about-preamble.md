...
MotionFrame includes third-party software covered by the licenses and notices
below. This document has three parts: notices for source code incorporated into
MotionFrame, licenses for bundled assets, and licenses for every library it
links against.
